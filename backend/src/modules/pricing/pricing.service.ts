  ...
  private plans: Plan[] = [
    {
      ...
      features: [
        ...
        'Только личные игры; участие в играх организаций на бесплатном тарифе недоступно',
      ],
    },
    {
    ...
    },
    {
      ...
      features: [
        ...
        'До 50 участников в организации (лимит настраивается в конфиге тарифов)',
    ...
    },
    {
      ...
      features: [
        ...
        'До 100 участников в организации (×2 к базовой орг-подписке, число из конфига)',
