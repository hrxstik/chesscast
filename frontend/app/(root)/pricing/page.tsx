          ...
          <Card className="border-border/80">
            <CardContent className="pt-6">
              ...
              <Text className="mt-2 text-sm text-muted-foreground">
                Да — оформление платного тарифа со страницы тарифов; смена тарифа при
                необходимости возможна в личном кабинете.
              </Text>
            </CardContent>
          </Card>
          <Card className="border-border/80">
            <CardContent className="pt-6">
              ...
              {freeFaq.length > 0 ? (
                ...
                <Text className="mt-2 text-sm text-muted-foreground">
                  Лимиты бесплатного тарифа задаются в настройках планов на сервере.
                </Text>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="flex flex-col gap-3 pt-6 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <Text className="mt-1 text-sm text-muted-foreground">
                  Напишите на support@chesscast.com — подберём лимиты участников и
                  партий.
                </Text>
              </div>
              <Link
