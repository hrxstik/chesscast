      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-5">
        ...
        <aside className="order-2 flex flex-col gap-3 lg:order-3 lg:col-span-4">
          <Card className="border-border/80">
            ...
            <CardContent className="max-h-[220px] overflow-y-auto p-0 px-4 pb-4">{movesPanel}</CardContent>
          </Card>
          <Card className="border-border/80">
            <CardHeader className="py-3">
              <CardTitle className="text-sm font-semibold md:text-base">Анализ</CardTitle>
            </CardHeader>
            <CardContent className="min-h-[200px] space-y-2 px-4 pb-4">{analysisPanel}</CardContent>
          </Card>
        </aside>
      </div>
    </div>
